...
const { listFiles, uploadFile, deleteFile, bulkDelete, downloadFiles, getPublicAsset } = require('../controllers/fileManagerController');
...
router.get('/public/*', asyncHandler(getPublicAsset));
